...
export declare class AuthenticationUtils {
    private constructor();
    static getAuthenticatedUserInfo(idToken: string): AuthenticatedUserInfo;
    private static filterClaimsFromIDTokenPayload;
    static extractUserName: (payload: DecodedIDTokenPayload, uidSeparator?: string) => string;
    static getTenantDomainFromIdTokenPayload: (payload: DecodedIDTokenPayload, uidSeparator?: string) => string;
    static getTokenRequestHeaders(): TokenRequestHeader;
}
